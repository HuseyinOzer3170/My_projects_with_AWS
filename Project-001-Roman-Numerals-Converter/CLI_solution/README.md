...
pip3 install flask
cd /home/ec2-user
FOLDER="https://raw.githubusercontent.com/HuseyinOzer3170/my_projects/main/Project-001-Roman-Numerals-Converter/"
wget ${FOLDER}/app.py
...
```bash
aws ec2 run-instances --image-id $LATEST_AMI --count 1 --instance-type t2.micro --key-name de05 --security-groups roman_numbers_sec_grp --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=roman_numbers}]' --user-data file:///home/ec2-user/userdata.sh
or
...
```bash
aws ec2 delete-security-group --group-name test_roman_numbers_sec_grp
```
